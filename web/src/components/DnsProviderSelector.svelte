<script lang="ts">
  ...
  const DNS_OPTIONS: readonly { value: DnsProviderType; label: string; hint: string }[] = [
    { value: DNS_PROVIDERS.CLOUDFLARE, label: 'Cloudflare', hint: '1.1.1.1 — fastest, privacy-focused' },
    ...
    { value: DNS_PROVIDERS.ADGUARD, label: 'AdGuard', hint: '94.140.14.14 — blocks ads at DNS level' },
  ] as const
