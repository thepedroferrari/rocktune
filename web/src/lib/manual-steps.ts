...
const REFERENCE_SOURCES_BY_ID: Record<string, readonly string[]> = {
  'gpu-scheduling': ['https://devblogs.microsoft.com/directx/hardware-accelerated-gpu-scheduling/'],
  'vrr-enable': [
  ...
  'nv-bench-gsync': ['https://www.nvidia.com/en-us/geforce/products/g-sync-monitors/'],
  'nv-pro-digital-vibrance': [
    'https://prosettings.net/players/peterbot/',
    'https://prosettings.net/players/veno/',
  ],
  'amd-freesync': ['https://www.amd.com/en/products/graphics/technologies/freesync.html'],
  'amd-pro-freesync': ['https://www.amd.com/en/products/graphics/technologies/freesync.html'],
  'amd-stream-freesync': ['https://www.amd.com/en/products/graphics/technologies/freesync.html'],
  'bios-rebar': [
  ...
  'diag-capframex': ['https://github.com/CXWorld/CapFrameX'],
  ...
  'amd-radeon-boost': ['https://www.amd.com/en/products/software/adrenalin/radeon-boost.html'],
  'amd-pro-radeon-boost': ['https://www.amd.com/en/products/software/adrenalin/radeon-boost.html'],
  'amd-stream-radeon-boost': [
  ...
  'steam-pro-overlay': ['https://help.steampowered.com/en/faqs/view/3978-072C-18DF-FBF9'],
  'mouse-polling': ['https://blurbusters.com/faq/mouse-guide/'],
  'mouse-pro-calibration': ['https://blurbusters.com/faq/mouse-guide/'],
  'refresh-rate': ['https://blurbusters.com/faq/120hz-monitors/'],
  'preflight-refresh-rate': ['https://blurbusters.com/faq/120hz-monitors/'],
  'preflight-reflex': [
...
const PREFLIGHT_ALL: ManualStepSection = {
  ...
  items: [
    ...
    },
    {
      ...
      fail: 'Default 15.6ms timer can cause micro-stutters (system-dependent; test with/without)',
      impact: 'medium',
      difficulty: 'quick',
      safety: 'safe',
    },
  ...
  items: [
    {
      ...
      value: 'Disabled',
      why: 'Controversial; can reduce TCP packet delays in rare cases but may increase overall latency. Most systems better with defaults. Test carefully before keeping.',
      impact: 'medium',
      difficulty: 'advanced',
      safety: 'moderate',
      automated: {
    ...
    },
    {
      ...
      why: 'Highly controversial; removes Windows 10/11 bandwidth throttling. Can help in rare cases but often degrades performance. Most systems better with defaults.',
      impact: 'medium',
      difficulty: 'advanced',
      safety: 'moderate',
      automated: {
...
const OBS_OUTPUT: ManualStepSection = {
  ...
  items: [
    ...
    },
    {
      ...
      why: 'NVENC Quality ≈ x264 Medium with only ~10% GPU usage (varies by preset and output resolution)',
      impact: 'high',
      difficulty: 'quick',
      safety: 'safe',
    },
...
const UBIQUITI_GAMING: ManualStepSection = {
  ...
  items: [
    ...
    },
    {
      ...
      why: 'Should achieve A or A+ grade with <20ms bufferbloat under load (target; actual depends on connection speed). If not, adjust SQM bandwidth limits.',
      impact: 'high',
      difficulty: 'quick',
      safety: 'safe',
    },
